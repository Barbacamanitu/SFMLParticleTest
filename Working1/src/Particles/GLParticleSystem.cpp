#include "stdafx.h"
#include "..\..\include\Particles\GLParticleSystem.h"
...
void GLParticleSystem::Initialize(size_t pCount)
{
	...
	//Load Texture
	sf::Image img_data;
	bool loaded = img_data.loadFromFile("sprites\\particle.png");
	...
	const sf::Uint8 * data = img_data.getPixelsPtr();
...
void GLParticleSystem::UpdateParticles(float delta, sf::Vector2i mousePos)
{
	...
	glm::vec2 mousePoss;
	mousePoss.x = mousePos.x;
	mousePoss.y = mousePos.y;
